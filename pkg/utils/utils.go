...
func (u *Utils) WaitForPod(timeout int, podname, namespace string) (string, bool) {
	elapsed := 0
	for {
		pod, _ := u.kubeclientset.CoreV1().Pods(namespace).Get(context.TODO(), podname, metav1.GetOptions{})
...
func (u *Utils) GetPodFullName(timeout int, podname, namespace string) (string, bool) {
	elapsed := 0
	for {
		pods, err := u.kubeclientset.CoreV1().Pods(namespace).List(context.TODO(), metav1.ListOptions{})
		if err != nil {
